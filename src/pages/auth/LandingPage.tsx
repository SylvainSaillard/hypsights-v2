...
const LandingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-hypsights-background">
      ...
      {/* Hero Section - Enhanced with better visuals and layout */}
      <section className="pt-20 pb-32 bg-gradient-to-b from-white to-hypsights-background relative overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-10">
          <div className="absolute top-20 left-10 w-64 h-64 rounded-full bg-primary transform rotate-45"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 rounded-full bg-secondary transform -rotate-12"></div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div>
                <div className="inline-flex items-center px-4 py-2 bg-primary-light bg-opacity-20 rounded-full text-primary-dark text-sm font-medium mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  to="/signup" 
                  className="bg-primary text-primary-foreground hover:bg-primary-dark transition-all duration-200 px-8 py-4 rounded-lg text-base font-semibold shadow-lg flex items-center justify-center"
                >
                ...
                <Link 
                  to="/login" 
                  className="bg-white text-gray-800 hover:bg-gray-50 border border-gray-300 transition-all duration-200 px-8 py-4 rounded-lg text-base font-semibold shadow-sm flex items-center justify-center"
                >
            ...
            <div className="hidden lg:block">
              <div className="relative">
                ...
                <div className="bg-white p-8 rounded-xl shadow-xl border border-gray-100 transform transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl">
                  <div className="bg-gray-50 rounded-lg overflow-hidden">
                    ...
                    <div className="p-6">
                      <div className="flex justify-between items-center mb-6">
                        <div>
                          <h3 className="text-lg font-semibold text-gray-900">AI-powered supplier search</h3>
                          <p className="text-sm text-gray-500">Find the best match for your business needs</p>
                        </div>
                ...
                {/* Decorative elements */}
                <div className="absolute -top-6 -right-6 w-24 h-24 bg-primary-light rounded-lg transform rotate-12 opacity-20"></div>
                <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-secondary-light rounded-full transform -rotate-12 opacity-20"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Features Section - Enhanced with better visuals and layout */}
      <section className="py-24 bg-hypsights-background relative">
        {/* Background decorative elements */}
        <div className="absolute inset-0 overflow-hidden z-0">
          <div className="absolute left-0 top-1/4 w-64 h-64 bg-gray-200 rounded-full opacity-30 transform -translate-x-1/2"></div>
          <div className="absolute right-0 bottom-1/4 w-64 h-64 bg-primary-light rounded-full opacity-20 transform translate-x-1/2"></div>
        </div>
        
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">How Hypsights works</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            {/* Feature 1 */}
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="w-16 h-16 bg-blue-100 rounded-2xl flex items-center justify-center mb-6 transform -rotate-3">
                <span className="text-blue-700 font-bold text-2xl">1</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-4">Create Your Brief</h3>
            ...
            {/* Feature 2 */}
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1 md:translate-y-4">
              <div className="w-16 h-16 bg-purple-100 rounded-2xl flex items-center justify-center mb-6 transform rotate-3">
            ...
            {/* Feature 3 */}
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-100 transform transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <div className="w-16 h-16 bg-green-100 rounded-2xl flex items-center justify-center mb-6 transform -rotate-3">
          ...
          <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="text-sm text-gray-600">Free searches</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="text-sm text-gray-600">Expert validation</div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md">
              <div className="text-3xl font-bold text-primary mb-2">B2B</div>
              <div className="text-sm text-gray-600">Focused platform</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white border-t border-gray-200 relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <svg className="absolute right-0 top-0 h-full text-hypsights-background opacity-20" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="512" height="512">
            <path fill="currentColor" d="M0 0h8v4H0V0zm0 8h20v4H0V8zm0 8h8v4H0v-4zm0 8h20v4H0v-4zm0 8h8v4H0v-4z"></path>
          </svg>
          <svg className="absolute left-0 bottom-0 h-full text-hypsights-background opacity-20 transform rotate-180" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="512" height="512">
            <path fill="currentColor" d="M0 0h8v4H0V0zm0 8h20v4H0V8zm0 8h8v4H0v-4zm0 8h20v4H0v-4zm0 8h8v4H0v-4z"></path>
          </svg>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Ready to find your ideal suppliers?</h2>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
              <Link 
                to="/signup" 
                className="bg-primary text-primary-foreground hover:bg-primary-dark transition-all duration-200 px-8 py-4 rounded-lg text-lg font-semibold shadow-lg flex items-center justify-center w-full sm:w-auto"
              >
                Get started for free
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
              ...
              <Link 
                to="/login" 
                className="text-gray-700 hover:text-primary transition-colors duration-200 px-6 py-4 text-lg font-medium flex items-center justify-center w-full sm:w-auto"
              >
