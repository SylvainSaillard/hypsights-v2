        ...
        <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-6 rounded-2xl shadow-lg text-white my-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl">Votre demande de recherche approfondie a été transmise à notre équipe d'experts. L'équipe Hypsights va vous recontacter très prochainement avec des résultats personnalisés.</p>
              <div className="mt-4 flex flex-wrap gap-2">
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm font-medium flex items-center"><span role="img" aria-label="processing">⏳</span><span className="ml-1.5">En cours de traitement</span></span>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm font-medium flex items-center"><span role="img" aria-label="expert">👥</span><span className="ml-1.5">Équipe d'experts</span></span>
                <span className="bg-white/20 px-3 py-1 rounded-full text-sm font-medium flex items-center"><span role="img" aria-label="contact">📞</span><span className="ml-1.5">Contact imminent</span></span>
              </div>
            </div>
