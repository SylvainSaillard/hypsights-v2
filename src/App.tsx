      ...
      <nav className="bg-card shadow-md p-4">
        <div className="container mx-auto max-w-container flex justify-between items-center">
          <Link to="/dashboard" className="flex items-center space-x-2">
            <img src="https://lmqagaenmseopcctkrwv.supabase.co/storage/v1/object/public/assets/logo_hypsights_v2-removebg-preview.png" alt="Hypsights Logo" className="h-8 w-auto" />
