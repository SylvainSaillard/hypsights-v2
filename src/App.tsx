...
const DashboardLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-hypsights-background">
      <nav className="bg-card shadow-md px-6 lg:px-12 xl:px-16 2xl:px-24 py-4">
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4 space-x-4">
            {isAdmin && (
              <Link
                to="/dashboard/admin"
                className="flex items-center gap-2 px-3 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-full text-sm font-medium hover:from-indigo-600 hover:to-purple-700 transition-all shadow-sm"
              >
      ...
      <main className="w-full px-6 lg:px-12 xl:px-16 2xl:px-24 py-4 md:py-6">
        <Outlet /> 
      </main>
    </div>
  );
